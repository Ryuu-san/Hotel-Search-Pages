! function(t, e, i) {
    ...
    function() {
        var t = '<div class="datepicker--nav-action datepicker--nav-action-prev" data-action="prev">#{prevHtml}</div><div class="datepicker--nav-title">#{title}</div><span class="datepicker--nav-action datepicker--nav-action-next" data-action="next">arrow_forward</span>',
